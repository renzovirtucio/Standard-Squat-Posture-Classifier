...
def build_feature_vectors(df):
  ...
  df['left_hip_to_left_knee'] = df.apply(lambda x: calculate_distance([x['x_23'], x['y_23']],
                                  [x['x_25'], x['y_25']]), axis=1)
  df['right_hip_to_right_knee'] = df.apply(lambda x: calculate_distance([x['x_24'], x['y_24']],
                                  [x['x_26'], x['y_26']]), axis=1)
  df['left_knee_to_left_ankle'] = df.apply(lambda x: calculate_distance([x['x_25'], x['y_25']],
                                  [x['x_27'], x['y_27']]), axis=1)
  df['right_knee_to_right_ankle'] = df.apply(lambda x: calculate_distance([x['x_26'], x['y_26']],
                                  [x['x_28'], x['y_28']]), axis=1)

  df['left_ankle_to_left_heel'] = df.apply(lambda x: calculate_distance([x['x_27'], x['y_27']],
                                  [x['x_29'], x['y_29']]), axis=1)
  df['left_heel_to_left_foot_index'] = df.apply(lambda x: calculate_distance([x['x_29'], x['y_29']],
                                  [x['x_31'], x['y_31']]), axis=1)
  df['left_foot_index_to_left_ankle'] = df.apply(lambda x: calculate_distance([x['x_31'], x['y_31']],
                                  [x['x_27'], x['y_27']]), axis=1)

  df['right_ankle_to_right_heel'] = df.apply(lambda x: calculate_distance([x['x_28'], x['y_28']],
                                  [x['x_30'], x['y_30']]), axis=1)
  df['right_heel_to_right_foot_index'] = df.apply(lambda x: calculate_distance([x['x_30'], x['y_30']],
                                  [x['x_32'], x['y_32']]), axis=1)
  df['right_foot_index_to_right_ankle'] = df.apply(lambda x: calculate_distance([x['x_32'], x['y_32']],
                                  [x['x_28'], x['y_28']]), axis=1)
